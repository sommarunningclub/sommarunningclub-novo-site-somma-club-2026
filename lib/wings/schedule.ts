...
export const WINGS_SCHEDULE: ScheduleBlock[] = [
  ...
  },
  {
    ...
    description: 'Ativação coletiva para deixar todo mundo no pique antes da largada.',
    details: [
      'Dinâmica coletiva de alto impacto conduzida pelo host',
      'Participação obrigatória de todos os presentes',
      'Red Bull liberado durante a ativação',
      'DJ em set de alta energia durante o hack',
    ],
    tags: ['energia'],
    isHighlight: true,
    isPublic: true,
  },
  {
    ...
    timeStart: '09:15',
    timeEnd: '10:30',
    title: 'Aquecimento + Competição — Revezamento 4×100m',
    description:
      'O coração do evento. Baterias classificatórias e finais do Revezamento 4×100m misto.',
    details: [
      ...
      'CLASSIFICAÇÃO: os 8 melhores tempos totais dos 400m avançam para a final',
      'FINAL: as 3 equipes com melhor tempo total são premiadas',
