    ...
    <main className="min-h-[100svh] bg-black pb-28 text-white lg:pb-16">
      ...
      <header className="sticky top-0 z-30 border-b border-[#1c1c1c] bg-black/90 backdrop-blur">
        <div className="mx-auto flex max-w-6xl items-center justify-between px-4 py-3.5 sm:px-6">
          ...
          {/* Atualizar (mobile) */}
          <button onClick={() => loadList(search, filterConhecia, filterUf)} disabled={loading} aria-label="Atualizar dados" className="flex items-center justify-center rounded-lg border border-[#2A2A2A] p-2.5 text-[#A1A1A1] transition hover:border-white/40 disabled:opacity-50 lg:hidden">
