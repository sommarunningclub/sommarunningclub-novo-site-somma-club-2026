...
// Estilo minimalista claro — fundo neutro, ruas suaves, vegetação discreta.
// Deixa a polyline vermelha como elemento principal de destaque.
const WFL_MAP_STYLES: google.maps.MapTypeStyle[] = [
  ...
  { featureType: 'administrative', elementType: 'geometry.stroke', stylers: [{ color: '#c9c0b4' }] },
  { featureType: 'administrative.land_parcel', elementType: 'labels', stylers: [{ visibility: 'off' }] },
  { featureType: 'poi', elementType: 'geometry', stylers: [{ color: '#ddd6cc' }] },
  { featureType: 'poi', elementType: 'labels', stylers: [{ visibility: 'off' }] },
  { featureType: 'poi.park', elementType: 'geometry.fill', stylers: [{ color: '#c8dbb0' }] },
  { featureType: 'poi.sports_complex', elementType: 'geometry.fill', stylers: [{ color: '#b8d49e' }] },
  { featureType: 'road', elementType: 'geometry', stylers: [{ color: '#ffffff' }] },
  { featureType: 'road', elementType: 'geometry.stroke', stylers: [{ color: '#d6cfc6' }] },
  ...
  { featureType: 'road.highway', elementType: 'geometry.stroke', stylers: [{ color: '#c9c0b4' }] },
  { featureType: 'road.local', elementType: 'labels', stylers: [{ visibility: 'off' }] },
  { featureType: 'transit', stylers: [{ visibility: 'off' }] },
  { featureType: 'water', elementType: 'geometry', stylers: [{ color: '#adc8d8' }] },
  { featureType: 'water', elementType: 'labels.text.fill', stylers: [{ color: '#7a9baf' }] },
]
